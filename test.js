...
describe('interlace', function () {
    ...
    it("should correctly read yet another indexed image", function(done) {
      return png.parseFile(path.join(__dirname, "data/s08n3p02.png"), function(err, id) {
        ...
        assert.equal(id.getPixel(  0,   0), 0xFFFFFFFF)
        assert.equal(id.getPixel(  0,   1), 0xFFFFFFFF)
        assert.equal(id.getPixel(  0,   2), 0xFFFFFFFF)
        assert.equal(id.getPixel(  0,   3), 0xFFFFFFFF)
        assert.equal(id.getPixel(  0,   4), 0xFFFFFFFF)
        assert.equal(id.getPixel(  0,   5), 0xFFFFFFFF)
        assert.equal(id.getPixel(  0,   6), 0xFFFFFFFF)
        assert.equal(id.getPixel(  0,   7), 0xFFFFFFFF)
        assert.equal(id.getPixel(  1,   0), 0xFFFFFFFF)
        assert.equal(id.getPixel(  1,   1), 0xFF77FFFF)
        assert.equal(id.getPixel(  1,   2), 0xFF77FFFF)
        assert.equal(id.getPixel(  1,   3), 0xFF77FFFF)
        assert.equal(id.getPixel(  1,   4), 0xFF77FFFF)
        assert.equal(id.getPixel(  1,   5), 0xFF77FFFF)
        assert.equal(id.getPixel(  1,   6), 0xFF77FFFF)
        assert.equal(id.getPixel(  1,   7), 0xFFFFFFFF)
        assert.equal(id.getPixel(  2,   0), 0xFFFFFFFF)
        assert.equal(id.getPixel(  2,   1), 0xFFFFFFFF)
        assert.equal(id.getPixel(  2,   2), 0xFFFFFFFF)
        assert.equal(id.getPixel(  2,   3), 0xFFFFFFFF)
        assert.equal(id.getPixel(  2,   4), 0xFFFFFFFF)
        assert.equal(id.getPixel(  2,   5), 0xFFFFFFFF)
        assert.equal(id.getPixel(  2,   6), 0xFFFFFFFF)
        assert.equal(id.getPixel(  2,   7), 0xFFFFFFFF)
        assert.equal(id.getPixel(  3,   0), 0xFFFFFFFF)
        assert.equal(id.getPixel(  3,   1), 0xFFFFFFFF)
        assert.equal(id.getPixel(  3,   2), 0xFFFFFFFF)
        assert.equal(id.getPixel(  3,   3), 0xFFFFFFFF)
        assert.equal(id.getPixel(  3,   4), 0xFFFFFFFF)
        assert.equal(id.getPixel(  3,   5), 0xFFFFFFFF)
        assert.equal(id.getPixel(  3,   6), 0xFFFFFFFF)
        assert.equal(id.getPixel(  3,   7), 0xFFFFFFFF)
        done()
      })
    })
});
